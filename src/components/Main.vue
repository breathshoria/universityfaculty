<template>
  <div>
    ...
    <modal v-if="modalOpen" @close="modalOpen = false" :data="modalData"></modal>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getApiData: function () {
        axios.all([
          axios.get('https://deepsfu.herokuapp.com/api/grades/')
            .then( response => {
              this.grades = response.data
            }),
          axios.get('https://deepsfu.herokuapp.com/api/directions/')
            .then( response => {
